...
def main(input_file,structure_file,output_file):
    ...
    args = Args()
    #args.loc_file = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS/location_line/loc_line_numbers.jsonl"
