...
file_names_self_evaluation_prompt = """ 
...
def self_evaluation_process_with_llm(loc, args, swe_bench_data, prev_o):
    ...
    raw_output = ""
    prompt_template = file_names_self_evaluation_prompt
...
def main(input_file,output_file):
    ...
    # Set default values
    #args.loc_file = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS/location_file/loc_file_names.jsonl"  # 请替换为实际的文件路径
    args.loc_file_folder = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS/location_file"  
    ...
    args.backend = "openai"
    args.output_folder = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS/self_eval_file_names"  # 请替换为实际的输出文件夹路径
