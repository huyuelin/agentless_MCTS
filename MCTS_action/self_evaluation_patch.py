...
Below are the file names that we have found for the issue:
--- BEGIN FILE NAMES ---
{file_names}
--- END FILE NAMES ---
...
Please generate `confidence number`  to judge whether the above patch and file names and function names can solve the above issue.
...
def main(input_file_patch,input_file_line_numbers,output_file):
    class Args:
        pass
    ...
    # Set default values
    #args.loc_file = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS/location_line/loc_line_numbers.jsonl"  # 请替换为实际的文件路径
    args.loc_file_folder = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS/location_line"
    args.loc_file = os.path.join(args.loc_file_folder,input_file_line_numbers)
    
    #args.patch_file = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS/repair_with_rerank/all_preds.jsonl"  # 请替换为实际的文件路径
    args.patch_file_folder = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS/repair_with_rerank"  # 请替换为实际的文件路径
    args.patch_file = os.path.join(args.patch_file_folder, input_file_patch)   
    args.top_n = 3
    ...
    args.backend = "openai"
    args.output_folder = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS/self_eval_patch"  # 请替换为实际的输出文件夹路径
