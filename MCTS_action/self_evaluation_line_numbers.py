...
Below are the line numbers and code contents around the line numbers that we have found for the issue:
...
def self_evaluation_process_with_llm(loc, args, swe_bench_data, prev_o):
    ...
    found_edit_locs= loc["found_edit_locs"]
    flattened_edit_locs = [item for sublist in found_edit_locs for item in sublist if item]
    
    topn_content = loc["topn_content"]
    ...
    message = prompt_template.format(
        ...
        line_numbers="\n".join(flattened_edit_locs),
        code_contents=topn_content,
...
def main(input_file,output_file):
    ...
    # Set default values
    #args.loc_file = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS_astropy_0827/location_line/localize_line_numbers_cbc2b987-75ef-4566-aa76-c09654cfb225.jsonl"  # 请替换为实际的文件路径
    ...
    #args.input_strcture_file = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS/location_file/localize_file_names_c58b3757-ff05-4111-86a6-40da1888df57.jsonl"  # 请替换为实际的文件路径
    args.top_n = 3
    ...
    args.backend = "openai"
    args.output_folder = "/home/wsl/AgentlessMCTS/Agentless/0822_MCTS/self_eval_line_numbers"  # 请替换为实际的输出文件夹路径
